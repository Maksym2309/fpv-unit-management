...
// Email адміна (хто може завершувати будь-який виліт) — задається у
// файлі Config.gs (з теки ГОЛОВНА_таблиця, той самий для обох таблиць).
// Тут його немає навмисно: Config вставляється один раз, і оновлення
// цього файлу не затирає твого значення.
